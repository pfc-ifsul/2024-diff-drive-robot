...
class WheelOdometry(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(f"{'='*20}\t Wheel odometry started \t{'='*20}")
        ...
        self.odometry_msg_.child_frame_id = "base_footprint_ekf" # data fusion real robot
        ...
        self.robot_speed_subscriber_ = self.create_subscription(
            ...
            topic="/measured_robot_speed",              # controller option 1 
    ...
    def robotSpeedCallback(self, msg):
        ...
        self.get_logger().info(f"x = {self.x_}")
        self.get_logger().info(f"y = {self.y_}")
        self.get_logger().info(f"theta = {self.theta_}")
        self.theta_ += angular_vel*dt
        self.x_ += linear_vel*dt*math.cos(self.theta_)
        self.y_ += linear_vel*dt*math.sin(self.theta_)
